...
fun MainScreen(
    ...
    Scaffold(
        ...
        Box(
            ...
            PlantCareNavHost(navController, getPlants())
        }
    }
}
...
fun getPlants() = listOf(
    ...
    Plants(4,"Nipple 8901234 56","succulent","nipple cactus","", "143", "", mapOf("20/3/23" to "here's a note", "9/29/23" to "Here's a much longer to not to check how this stuff looks in multiple lines and yeah it seems to be working okay", "30/60/40" to "another one to see if it's scrollable"),
        listOf(
          Tasks(0, 0, "task 1", true, "", 0, true, 6, "", 7),
          Tasks(0, 0, "task 2", true, "", 0, true, 9, "", 3),
          //Tasks(0, 0, "task 3", true, "", 0, true, 9, "", 3)
        )
    ),
